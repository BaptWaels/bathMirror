...
weatherModule.service('weatherService', function($http) {
    var service = {
      ...
      getWeather: function(location) {
        ...
        $http.get('http://api.openweathermap.org/data/2.5/weather?q='+location+'&units=metric&cnt=5').success(function(data) {
            if (data) {
                if (data.main) {
      ...
      getForecast: function(location) {
        ...
        $http.get('http://api.openweathermap.org/data/2.5/forecast/daily?q='+location+'&units=metric&cnt=4').success(function(data) {
            if (data) {
